...
namespace DwarfCodeData.Migrations
{
    ...
    [Migration("20250108104551_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimeUser", b =>
                {
                    ...
                    b.HasKey("AnimesAnimeId", "UsersUserId");
            ...
            modelBuilder.Entity("AnimeUser", b =>
                {
                    b.HasOne("DwarfCodeData.Models.Anime", null)
                        .WithMany()
                        .HasForeignKey("AnimesAnimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DwarfCodeData.Models.User", null)
                        .WithMany()
